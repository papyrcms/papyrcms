...
class BlogRoutes {
  ...
  registerRoutes() {
    ...
    this.server.get('/blog/new', this.renderPage.bind(this, '_create'))
    this.server.get('/blog/:id', this.renderPage.bind(this, '_show'))
    this.server.get('/blog/:id/edit', this.renderPage.bind(this, '_edit'))

    // Blog API
    this.server.post('/api/blogs', this.createBlog.bind(this))
    this.server.get('/api/blogs', this.sendAllBlogs.bind(this))
    ...
    this.server.put('/api/blogs/:id', this.updateBlog.bind(this))
    this.server.delete('/api/blogs/:id', this.deleteBlog.bind(this))
  }
