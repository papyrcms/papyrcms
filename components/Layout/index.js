  ...
  return (
    <div className="app">
      ...
      <Head>
        ...
        <link rel="shortcut icon" type="image/x-icon" href="/public/cup.png" />
        <link rel="apple-touch-icon" sizes="57x57" href="/public/cup.png" />
        <link rel="apple-touch-icon" sizes="180x180" href="/public/cup.png" />
